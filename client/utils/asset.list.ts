...
export const imageAssets = [
    ...
    require('@/client/assets/images/partial-react-logo.png'),
    require('@/client/assets/images/android-icon-monochrome.png'),
    require('@/client/assets/images/react-logo.png'),
    ...
    require('@/client/assets/images/background/bg_pattern.png'),
    require('@/client/assets/images/background/bg_items.png'),

    require('@/client/assets/images/items/logo.png'),
];
